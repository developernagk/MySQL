...
create view studentCourseView as
	select s.firstName as studentFirstName, s.lastName as studentLastName, c.courseName, c.instructor
	from studentCourse sc inner join students s on sc.studentId = s.studentId
